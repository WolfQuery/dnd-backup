...
**Classes**: [Bard](bard.md), [Fighter (Eldritch Knight)](fighter-eldritch-knight.md), [Monk (Way of Shadow)](monk-way-of-shadow.md), [Rogue (Arcane Trickster)](rogue-arcane-trickster.md), [Sorcerer](sorcerer.md), [Warlock](warlock.md), [Wizard (School of Illusion)](wizard-school-of-illusion.md), [Wizard](wizard.md)
