...
- A [shield](2.%20Mechanics/compendium/items/shield.md) and a [holy symbol](holy-symbol.md)  
...
You can make a cleric quickly by following these suggestions. First, Wisdom should be your highest ability score, followed by Strength or Constitution. Second, choose the [acolyte](z_published%20files/2.%20Mechanics/compendium/backgrounds/acolyte.md) background.
